...
func (uu *UserUpdate) AddReadIDs(ids ...int) *UserUpdate {
...
func (uu *UserUpdate) RemoveReadIDs(ids ...int) *UserUpdate {
...
// AddReadIDs adds the "reads" edge to the Read entity by IDs.
func (uuo *UserUpdateOne) AddReadIDs(ids ...int) *UserUpdateOne {
...
// RemoveReadIDs removes the "reads" edge to Read entities by IDs.
func (uuo *UserUpdateOne) RemoveReadIDs(ids ...int) *UserUpdateOne {
